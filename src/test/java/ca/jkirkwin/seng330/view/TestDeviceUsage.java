...
public class TestDeviceUsage extends IOTApplicationGUITest {
  ...
  public void doTestThermostatUsage(boolean isAdmin, Thermostat t) {
    ...
    Temperature newTemp = new Temperature(newMagnitude, Temperature.Unit.FAHRENHEIT);
    clickOn("#temp_field");
    ...
    newTemp.changeUnit(Temperature.Unit.CELSIUS);
    ...
    newTemp = new Temperature(rediculousMagnitude, Temperature.Unit.CELSIUS);
    clickOn("#temp_field");

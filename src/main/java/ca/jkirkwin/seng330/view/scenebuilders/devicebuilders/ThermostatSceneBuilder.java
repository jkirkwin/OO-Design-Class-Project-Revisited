...
import ca.jkirkwin.seng330.controller.ThermostatController;
...
public class ThermostatSceneBuilder extends DeviceSceneBuilder {
  ...
  protected Node buildSpecifics() {
    ...
    ArrayList<Temperature.Unit> degreeTypes = getController().getThermostatDegreeTypes();
        ...
        event ->
            getController()
                .constructTemp(
                    deviceID,
                    tempNum.getText(),
                    (Temperature.Unit) degrees.getSelectedToggle().getUserData()));

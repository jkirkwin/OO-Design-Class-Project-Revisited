...
public class FXClient extends Client {
  ...
  public void setView(ViewType view) {
    ...
    // about the model, but this seems like it might be just on the line of violating the MVC
    // pattern

    // Another alternative: add 'Object arg' in client interface, and for the FXController we can
    // either
    // pass in a scene, or a sceneBuilder which has been set up so that a call to build() generates
    // the
    // correct scene
